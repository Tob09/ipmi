...
void setup() {
 ...
 centroY = height/2;
 centroX = width/2;
 imagenes = new PImage[8];
 imagenes[0] = loadImage("diapositiva1.png");
 imagenes[1] = loadImage("diapositiva2.png");
 imagenes[2] = loadImage("diapositiva3.png");
 imagenes[3] = loadImage("diapositiva4.png");
 imagenes[4] = loadImage("diapositiva5.png");
 imagenes[5] = loadImage("diapositiva6.png");
 imagenes[6] = loadImage("diapositiva7.png");
 imagenes[7] = loadImage("diapositiva8.png");
}
